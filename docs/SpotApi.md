...
currency_pair = 'BTC_USDT' # str | Specify the transaction pair to query. If you are querying pending order records, this field is traded records, this field can be left blank.
account = 'spot' # str | Specify query account. (optional)
 ...
 **currency_pair** | **str**| Specify the transaction pair to query. If you are querying pending order records, this field is traded records, this field can be left blank. | 
 **account** | **str**| Specify query account. | [optional] 
