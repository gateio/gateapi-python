...
interval = '5m' # str | Time interval between data points, note that 1w represents a natural week, 7d time is aligned with Unix initial timeweek  (optional) (default to '5m')
 ...
 **interval** | **str**| Time interval between data points, note that 1w represents a natural week, 7d time is aligned with Unix initial timeweek  | [optional] [default to &#39;5m&#39;]
