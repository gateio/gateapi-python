...
class FuturesApi(object):
    ...
    def create_order(self, futures_order, **kwargs):  # noqa: E501
        """Create a futures order  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_order(futures_order, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.create_order_with_http_info(futures_order, **kwargs)  # noqa: E501
        else:
            (data) = self.create_order_with_http_info(futures_order, **kwargs)  # noqa: E501
            return data

    def create_order_with_http_info(self, futures_order, **kwargs):  # noqa: E501
        """Create a futures order  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_order_with_http_info(futures_order, async_req=True)
        >>> result = thread.get()
        ...
        if ('futures_order' not in local_var_params or
            ...
            raise ValueError("Missing the required parameter `futures_order` when calling `create_order`")  # noqa: E501
