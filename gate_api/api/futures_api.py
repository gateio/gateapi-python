...
class FuturesApi(object):
    ...
    def list_futures_candlesticks(self, settle, contract, **kwargs):  # noqa: E501
        ...
        :param str interval: Interval time between data points. Note that `1w` means natual week(Mon-Sun), while `7d` means every 7d since unix 0. 1 natual month, not 30 days
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_liquidated_orders(self, settle, **kwargs):  # noqa: E501
        ...
        The time interval between from and to is maximum 3600. Some private fields are not returned by public interfaces, refer to field descriptions for interfaces, refer to field descriptions for details  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def list_futures_account_book(self, settle, **kwargs):  # noqa: E501
        ...
        If the contract field is passed, only records containing this field after 2023-10-30 can be filtered。 2023-10-30 can be filtered.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_position_margin(self, settle, contract, change, **kwargs):  # noqa: E501
        ...
        :param str settle: Settle currency. (required)
        :param str contract: Futures contract. (required)
        :param str change: Margin change amount, positive number increases, negative number. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def set_dual_mode(self, settle, dual_mode, **kwargs):  # noqa: E501
        ...
        The prerequisite for changing mode is that all positions have no holdings.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def cancel_batch_future_orders(self, settle, request_body, **kwargs):  # noqa: E501
        ...
        Multiple different order IDs can be specified. A maximum of 20 records.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def amend_batch_future_orders(self, settle, batch_amend_order_req, **kwargs):  # noqa: E501
        ...
        Multiple different order IDs can be specified. A maximum of 10 orders can.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
