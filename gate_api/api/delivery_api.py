...
class DeliveryApi(object):
    ...
    def list_delivery_candlesticks(self, settle, contract, **kwargs):  # noqa: E501
        ...
        :param str interval: Time interval between data points, note that 1w represents a natural week, 7d time is aligned with Unix initial timeweek, 7d time is aligned with Unix initial time
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
