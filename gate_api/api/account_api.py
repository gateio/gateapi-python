...
class AccountApi(object):
    ...
    def list_stp_groups_users(self, stp_id, **kwargs):  # noqa: E501
        ...
        Only the main account that created this STP group can query the account.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def add_stp_group_users(self, stp_id, request_body, **kwargs):  # noqa: E501
        ...
        - Only the master account that created the STP user group is allowed to add users group.- Only accounts under the main account are allowed to be added. Cross-account is not permitted  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
