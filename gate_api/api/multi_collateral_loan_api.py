...
class MultiCollateralLoanApi(object):
    ...
    def list_multi_collateral_orders(self, **kwargs):  # noqa: E501
        ...
        :param str sort: Query the current interest rate of the currency in the previous hour.
    ...
    def list_user_currency_quota(self, type, currency, **kwargs):  # noqa: E501
        ...
        :param bool async_req: execute request asynchronously
        :param str type: Currency type: collateral - Collateral currency, borrow - Borrowing. (required)
        :param str currency: When it is a collateral currency, multiple currencies can be passed separated by commas; when it is a borrowing currency, only one currency can be passedseparated by commas; when it is a borrowing currency, only one currency can be passedseparated by commas; when it is a borrowing currency, only one commas; when it is a borrowing currency, only one currency can be passed (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_multi_collateral_current_rate(self, currencies, **kwargs):  # noqa: E501
        ...
        Query the current interest rate of the currency in the previous hour.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param bool async_req: execute request asynchronously
        :param list[str] currencies: Specify currency name query array, separated by commas, maximum 100items. (required)
