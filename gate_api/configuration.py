...
conf = gate_api.Configuration(
    ...
    def to_debug_report(self):
        ...
        return (
            ...
            "Version of the API: 4.21.2\n"
            "SDK Package Version: 4.21.2".format(env=sys.platform, pyversion=sys.version)
        )
    ...
    def get_host_settings(self):
        ...
        """
        return [
            {'url': "https://api.gateio.ws/api/v4", 'description': "Real Trading",},
            {'url': "https://fx-api-testnet.gateio.ws/api/v4", 'description': "TestNet Trading",},
        ]
