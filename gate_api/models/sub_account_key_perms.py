...
class SubAccountKeyPerms(object):
    ...
    def __init__(self, name=None, read_only=None, local_vars_configuration=None):  # noqa: E501
        ...
        """SubAccountKeyPerms - a model defined in OpenAPI"""  # noqa: E501
    ...
    def name(self):
        ...
        Permission name (all permissions will be removed if no value is passed)  - wallet: wallet - spot: spot/margin - futures: perpetual contract - delivery: delivery - earn: earn - options: options\\m- account: Account - unified: unified - loan: Loan  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubAccountKeyPerms):
            return False
