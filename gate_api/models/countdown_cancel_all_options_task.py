...
class CountdownCancelAllOptionsTask(object):
    ...
    """
    openapi_types = {'timeout': 'int', 'contract': 'str', 'underlying': 'str'}

    attribute_map = {'timeout': 'timeout', 'contract': 'contract', 'underlying': 'underlying'}

    def __init__(self, timeout=None, contract=None, underlying=None, local_vars_configuration=None):  # noqa: E501
        # type: (int, str, str, Configuration) -> None
        """CountdownCancelAllOptionsTask - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CountdownCancelAllOptionsTask):
            return False
