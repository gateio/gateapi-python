...
class FuturesInitialOrder(object):
    ...
    def __init__(self, contract=None, size=None, price=None, close=False, tif='gtc', text=None, reduce_only=False, is_reduce_only=None, is_close=None):  # noqa: E501
    ...
    def reduce_only(self):
        ...
        Set to true to create an post-only order  # noqa: E501
