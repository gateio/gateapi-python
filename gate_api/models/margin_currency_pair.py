...
class MarginCurrencyPair(object):
    ...
    def __init__(self, id=None, base=None, quote=None, leverage=None, min_base_amount=None, min_quote_amount=None, max_quote_amount=None, local_vars_configuration=None):  # noqa: E501
