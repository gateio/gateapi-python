...
class DepositAddress(object):
    ...
    """
    openapi_types = {'currency': 'str', 'address': 'str'}

    attribute_map = {'currency': 'currency', 'address': 'address'}

    def __init__(self, currency=None, address=None, local_vars_configuration=None):  # noqa: E501
