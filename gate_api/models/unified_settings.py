...
class UnifiedSettings(object):
    ...
    """
    openapi_types = {'usdt_futures': 'bool', 'spot_hedge': 'bool', 'use_funding': 'bool', 'options': 'bool'}
    ...
    def __init__(
        self, usdt_futures=None, spot_hedge=None, use_funding=None, options=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def usdt_futures(self):
        ...
        USDT contract switch. If not transmitted, the current switch value is used. If not transmitted for the first time, the default value is off.  # noqa: E501
    ...
    def spot_hedge(self):
        ...
        Spot hedging switch. If not transmitted, the current switch value is used. If not transmitted for the first time, the default value is off.  # noqa: E501
    ...
    def options(self):
        ...
        Option switch. If not transmitted, the current switch value is used. If not transmitted for the first time, the default value is off.  # noqa: E501
