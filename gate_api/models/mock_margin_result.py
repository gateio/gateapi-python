...
class MockMarginResult(object):
    ...
    def type(self):
        ...
        Position combination type `original_position` - Original position `long_delta_original_position` - Positive delta + Original position `short_delta_original_position` position  # noqa: E501
    ...
    def profit_loss_ranges(self):
        ...
        The results of 3 pressure scenarios for MR1.  # noqa: E501
