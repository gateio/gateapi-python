...
class RebateUserInfo(object):
    ...
    def __init__(self, invite_uid=None, local_vars_configuration=None):  # noqa: E501
        ...
        """RebateUserInfo - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._invite_uid = None
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RebateUserInfo):
            return False
