...
class UniLoanInterestRecord(object):
    ...
    def __init__(self, currency=None, currency_pair=None, actual_rate=None, interest=None, status=None, type=None, create_time=None, local_vars_configuration=None):  # noqa: E501
