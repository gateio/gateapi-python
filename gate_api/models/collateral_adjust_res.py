...
class CollateralAdjustRes(object):
    ...
    """
    openapi_types = {'order_id': 'int', 'collateral_currencies': 'list[CollateralCurrencyRes]'}

    attribute_map = {'order_id': 'order_id', 'collateral_currencies': 'collateral_currencies'}
