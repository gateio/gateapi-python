...
class RepayRecordTotalInterest(object):
    ...
    """
    openapi_types = {'currency': 'str', 'index_price': 'str', 'amount': 'str', 'amount_usdt': 'str'}
    ...
    def __init__(
        self, currency=None, index_price=None, amount=None, amount_usdt=None, local_vars_configuration=None
    ):  # noqa: E501
