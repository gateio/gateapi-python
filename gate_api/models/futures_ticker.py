...
class FuturesTicker(object):
    ...
    def __init__(self, contract=None, last=None, change_percentage=None, total_size=None, volume_24h=None, mark_price=None, funding_rate=None, index_price=None, quanto_base_rate=None):  # noqa: E501
