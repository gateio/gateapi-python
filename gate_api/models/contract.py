...
class Contract(object):
    ...
    def mark_type(self):
        ...
        Mark price type, internal - based on internal trading, external index price  # noqa: E501
    ...
    def in_delisting(self):
        ...
        `in_delisting=true` And when position_size>0, it means the contract is in the offline transition period `in_delisting=true` contract is offline  # noqa: E501
    ...
    def status(self):
        ...
        Contract Status Types include: prelaunch, trading, delisting, delisted.  # noqa: E501
