...
class StructuredBuy(object):
    ...
    """
    openapi_types = {'pid': 'str', 'amount': 'str'}

    attribute_map = {'pid': 'pid', 'amount': 'amount'}

    def __init__(self, pid=None, amount=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, str, Configuration) -> None
        """StructuredBuy - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StructuredBuy):
            return False
