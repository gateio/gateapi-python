...
class SmallBalanceHistory(object):
    ...
    """
    openapi_types = {'id': 'str', 'currency': 'str', 'amount': 'str', 'gt_amount': 'str', 'create_time': 'int'}
    ...
    def __init__(
        self, id=None, currency=None, amount=None, gt_amount=None, create_time=None, local_vars_configuration=None
    ):  # noqa: E501
