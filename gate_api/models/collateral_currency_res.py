...
class CollateralCurrencyRes(object):
    ...
    """
    openapi_types = {'succeeded': 'bool', 'label': 'str', 'message': 'str', 'currency': 'str', 'amount': 'str'}
    ...
    def __init__(
        self, succeeded=None, label=None, message=None, currency=None, amount=None, local_vars_configuration=None
    ):  # noqa: E501
