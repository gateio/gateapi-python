...
class UnifiedDiscount(object):
    ...
    """
    openapi_types = {'currency': 'str', 'discount_tiers': 'list[UnifiedDiscountTiers]'}

    attribute_map = {'currency': 'currency', 'discount_tiers': 'discount_tiers'}

    def __init__(self, currency=None, discount_tiers=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, list[UnifiedDiscountTiers], Configuration) -> None
        """UnifiedDiscount - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._currency = None
        self._discount_tiers = None
        self.discriminator = None

        if currency is not None:
            self.currency = currency
        if discount_tiers is not None:
    ...
    def discount_tiers(self):
        ...
        """
        return self._discount_tiers

    @discount_tiers.setter
    def discount_tiers(self, discount_tiers):
        ...
        self._discount_tiers = discount_tiers
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnifiedDiscount):
            return False
