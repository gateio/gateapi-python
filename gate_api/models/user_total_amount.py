...
class UserTotalAmount(object):
    ...
    """
    openapi_types = {'borrow_amount': 'str', 'collateral_amount': 'str'}

    attribute_map = {'borrow_amount': 'borrow_amount', 'collateral_amount': 'collateral_amount'}
