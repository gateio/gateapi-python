...
class PartnerSubList(object):
    ...
    """
    openapi_types = {'total': 'int', 'list': 'list[PartnerSub]'}

    attribute_map = {'total': 'total', 'list': 'list'}

    def __init__(self, total=None, list=None, local_vars_configuration=None):  # noqa: E501
        # type: (int, list[PartnerSub], Configuration) -> None
        """PartnerSubList - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnerSubList):
            return False
