...
class PartnerCommissionHistory(object):
    ...
    def __init__(self, total=None, list=None, local_vars_configuration=None):  # noqa: E501
        # type: (int, list[AgencyCommission], Configuration) -> None
        """PartnerCommissionHistory - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnerCommissionHistory):
            return False
