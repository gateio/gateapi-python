...
class PatchUniLend(object):
    ...
    """
    openapi_types = {'currency': 'str', 'min_rate': 'str'}

    attribute_map = {'currency': 'currency', 'min_rate': 'min_rate'}

    def __init__(self, currency=None, min_rate=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, str, Configuration) -> None
        """PatchUniLend - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PatchUniLend):
            return False
