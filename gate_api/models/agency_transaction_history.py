...
class AgencyTransactionHistory(object):
    ...
    """
    openapi_types = {'currency_pair': 'str', 'total': 'int', 'list': 'list[AgencyTransaction]'}
    ...
    def __init__(self, currency_pair=None, total=None, list=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, int, list[AgencyTransaction], Configuration) -> None
        """AgencyTransactionHistory - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AgencyTransactionHistory):
            return False
