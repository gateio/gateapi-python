...
class MultiLoanItem(object):
    ...
    """
    openapi_types = {'currency': 'str', 'price': 'str'}

    attribute_map = {'currency': 'currency', 'price': 'price'}

    def __init__(self, currency=None, price=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, str, Configuration) -> None
        """MultiLoanItem - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MultiLoanItem):
            return False
