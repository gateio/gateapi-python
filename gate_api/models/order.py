...
class Order(object):
    ...
    def __init__(self, id=None, create_time=None, status=None, currency_pair=None, type='limit', account='spot', side=None, amount=None, price=None, time_in_force='gtc', left=None, fill_price=None):  # noqa: E501
